...
public class CustomerService {
    ...
    public Mono<Page<CustomerDTO>> queryCustomers(List<SearchCriteria> searchCriteria, Pageable pageable) {
        return Requester.currentRequester()
                ...
                .map(requester -> {
                    ...
                    return customerRepository.findAll(SearchSpecification.allOf(searchCriteria), pageRequest)
                            .map(this::toDTO);
                });
    }
    ...
    private CustomerDTO toDTO(Customer customer) {
        ...
        return new CustomerDTO(
                ...
                userEquityInfoService.userEquities(customer.getUser().getUserId()).stream()
                        .map(UserEquityInfoDTO::from)
                        .toList(),
