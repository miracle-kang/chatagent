package com.miraclekang.chatgpt.assistant.port.adapter.enviroment;
...
public class ApiConfig {
    ...
    public GroupedOpenApi adminApi() {
        return GroupedOpenApi.builder()
                ...
                .packagesToScan("com.miraclekang.chatgpt.assistant.port.adapter.restapi.admin")
    ...
    public GroupedOpenApi internalApi() {
        return GroupedOpenApi.builder()
                ...
                .packagesToScan("com.miraclekang.chatgpt.assistant.port.adapter.restapi.internal")
                .addOpenApiCustomizer(openApiCustomizer())
                .build();
    }
    ...
    public GroupedOpenApi openApi() {
        return GroupedOpenApi.builder()
                ...
                .packagesToScan("com.miraclekang.chatgpt.assistant.port.adapter.restapi.open")
                .addOpenApiCustomizer(openApiCustomizer())
                .build();
    }
